    ...
    <Card className="dark:bg-dark-1000/50">
      <div className="p-2 md:p-4">
          ...
          <div className="flex items-start sm:items-center gap-4 sm:gap-5">
            <div className="w-3/12 sm:w-auto flex justify-center">
              <div className="dark:hidden w-fit">
                <Image
                  className="block sm:hidden  min-w-[75px]"
                  as={NextImage}
                  width={75}
                  height={75}
                  src="/images/buzzi.png"
                  radius="none"
                />
                <Image
            ...
            <div className="max-w-9/12 sm:w-auto flex flex-col">
              ...
              <span className="block md:hidden font-regular text-lg sm:text-xl text-nowrap	">
                2014 - 2019
              </span>
            </div>
          </div>
          <div className="hidden md:block">
            <span className="font-regular text-lg md:text-xl text-nowrap	">
              2014 - 2019
            </span>
          </div>
        </CardHeader>
        ...
        <CardFooter className="justify-between items-end">
          <Button
            className="text-base border-default-700"
