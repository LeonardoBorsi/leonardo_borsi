...
export const LinkedinIcon: React.FC<IconSvgProps> = ({ size = 28, width, height, ...props }) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' height={size || height} width={size || width} viewBox='0 0 30 30' {...props}>
      <path
...
export const YouTubeIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={size || width} height={size || height} viewBox='0 0 50 50' {...props}>
      <path
...
export const DownloadIcon = ({ size = 20, width, height, ...props }: IconSvgProps) => (
  <svg
...
export const SendIcon = ({ size = 20, width, height, ...props }: IconSvgProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    height={size || height}
    width={size || width}
...
export const PhoneIcon = ({ size = 20, width, height, ...props }: IconSvgProps) => (
...
export const MailIcon = ({ size = 20, width, height, ...props }: IconSvgProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    height={size || height}
    width={size || width}
...
export const ExternalLinkIcon = ({ size = 20, width, height, ...props }: IconSvgProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    height={size || height}
    width={size || width}
