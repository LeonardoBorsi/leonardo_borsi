      ...
      <div className='h-screen pb-32'>
        <div className='h-full flex flex-col justify-between py-20'>
          <div className='text-center lg:text-left'>
            ...
            <h2 className='text-4xl lg:text-5xl font-thin mt-3'>Software Engineer</h2>
            <h3 className='text-3xl lg:text-4xl font-thin text-primary mt-3'>UX/UI Designer</h3>
            <div className='mt-10 flex flex-col sm:flex-row justify-center lg:justify-start gap-5'>
              ...
              <Button
                as={Link}
                color='primary'
                className='text-base font-medium bg-primary'
                href='#contacts'
